...
-- ---------- telling a buyer a held item is back ----------
-- See supabase/migrations/2026-09-24-waitlist.sql for the why, and for the
-- two Vault secrets (resend_api_key, notify_from) sending needs.
