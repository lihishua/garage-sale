...
export const STR = {
  he: {
    ...
    linkSentFine: "הקוד תקף לשעה. במייל יש גם קישור, אם נוח לכם יותר ללחוץ עליו.",
    resend: "לשלוח שוב",
  ...
  en: {
    ...
    linkSentFine: "The code lasts an hour. The email has a link too, if tapping is easier.",
