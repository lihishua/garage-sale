...
export const STR = {
  he: {
    ...
    priceForEach: "לכל פריט בנפרד",
    priceForAll: "לכל המארז ביחד",
    ...
    sizeW: "רוחב", sizeL: "אורך", sizeD: "עומק",
  ...
  en: {
    ...
    priceForEach: "for each item",
    priceForAll: "for the whole lot",
    ...
    sizeW: "width", sizeL: "length", sizeD: "depth",
