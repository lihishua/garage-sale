...
export const STR = {
  he: {
    ...
    privNot2: "הגופנים נטענים משרתי Google Fonts, כך ש-Google רואה את כתובת ה-IP שלכם כשהעמוד נטען — כמו בכל אתר שמשתמש בהם. מעבר לזה, שום צד שלישי לא רואה כלום.",
    ...
    flyer: "יצירת פלייר",
    flyerTitle: "פלייר למכירה",
    flyerMaking: "מכינים את הפלייר…",
    flyerFailed: "לא הצלחנו ליצור את הפלייר.",
    flyerSend: "שליחה",
    flyerSave: "שמירה לתמונות",
    flyerHint: "הלינק בתמונה לא לחיץ, אז כשמשתפים דרך \"שליחה\" הוא נשלח יחד איתה. אפשר גם ללחוץ לחיצה ארוכה על התמונה כדי לשמור אותה.",
  ...
  en: {
    ...
    privNot2: "Fonts are loaded from Google Fonts, so Google sees your IP address when a page loads — as on any site that uses them. Beyond that, no third party sees anything.",
    ...
    flyerHint: "The link in the picture can't be tapped, so \"Send\" sends it along with the image. You can also long-press the image to save it.",
    flyerText: (name: string) => ({
